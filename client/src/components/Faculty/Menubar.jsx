...
const Menubar = ({toggleMenuOptions, handleProfileClick, handleShowFeedbackClick}) => {
    ...
    <div className={`menubar-parent ${expanded ? "expanded": ""}`}>
      <div className="menubar-frame-wrapper">
        <div className="user-parent">
          ...
          <div className="icon-div" onClick={handleShowFeedbackClick}>
          <img
            ...
            src="/feedbacks.png"
          />
          {expanded && <span className="add-data-text">Feedbacks</span>}
          </div>
